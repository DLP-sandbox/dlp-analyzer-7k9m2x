...
_JERGA_ES = [
    ...
    (r"cash burn", "quema de caja"),
    (r"burn rate", "ritmo de quema de caja"),
    (r"false breaks?", "rupturas falsas"),
    (r"ramp[- ]?up", "aceleración"),
    (r"de[- ]?rating", "caída del múltiplo"),
    (r"bounce", "rebote"),
    (r"rebound", "rebote"),
    (r"dip", "bajada puntual"),
    (r"runway", "recorrido de crecimiento"),
    (r"flywheel", "círculo virtuoso"),
    (r"overhang", "presión vendedora latente"),
    (r"churn", "pérdida de clientes"),
    (r"backlog", "pedidos pendientes"),
    (r"bookings", "contratos firmados"),
    (r"compounding", "crecimiento compuesto"),
    (r"catalysts?", "catalizadores"),
    (r"deleveraging", "reducción de deuda"),
    (r"TTM", "de los últimos 12 meses"),
